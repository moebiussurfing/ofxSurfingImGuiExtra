...
void ofApp::draw() 
{
	ui.Begin();
	{
		...
		{
			ui.Add(size2, OFX_IM_HSLIDER);
			ui.Add(amount);
			ui.Add(shapeType2, OFX_IM_HSLIDER_BIG);
			ui.Add(shapeType3, OFX_IM_HSLIDER_MINI_NO_NAME);
			ui.Add(size, OFX_IM_VSLIDER);
			ui.Add(shapeType, OFX_IM_STEPPER);
